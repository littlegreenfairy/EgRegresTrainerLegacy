...
class RegArgs:
    def set_defaults(self):
        ...
        self.tree_name = "BToKLLmc_dumper/selected"
        ...
        self.mean_max = 2.0
        self.fix_mean = False
        self.input_testing = "CCToEEPrompt_mc_2025Apr25_preEE.root"
        self.input_training = "CCToEEPrompt_mc_2025Apr25_postEE.root"
        self.target = "Gen_E/(rawEnergySCEle[0])"
        self.var_eb = "nPV:rawEnergySCEle[0]:etaSCEle[0]:phiSCEle[0]:energy_5x5SC/rawEnergySCEle[0]"  
       # self.var_ee = "nrVert:sc.rawEnergy:sc.etaWidth:sc.phiWidth:ssFrac.e3x3/sc.rawEnergy:sc.seedClusEnergy/sc.rawEnergy:ssFrac.eMax/sc.rawEnergy:ssFrac.e2nd/sc.rawEnergy:ssFrac.eLeftRightDiffSumRatio:ssFrac.eTopBottomDiffSumRatio:ssFrac.sigmaIEtaIEta:ssFrac.sigmaIEtaIPhi:ssFrac.sigmaIPhiIPhi:sc.numberOfSubClusters:sc.clusterMaxDR:sc.clusterMaxDRDPhi:sc.clusterMaxDRDEta:sc.clusterMaxDRRawEnergy/sc.rawEnergy:clus1.clusterRawEnergy/sc.rawEnergy:clus2.clusterRawEnergy/sc.rawEnergy:clus3.clusterRawEnergy/sc.rawEnergy:clus1.clusterDPhiToSeed:clus2.clusterDPhiToSeed:clus3.clusterDPhiToSeed:clus1.clusterDEtaToSeed:clus2.clusterDEtaToSeed:clus3.clusterDEtaToSeed:sc.iEtaOrX:sc.iPhiOrY:sc.seedEta"
        self.cuts_base = "(isTrain>0 && sqrt((Gen_Eta - etaEle[0])*(Gen_Eta - etaEle[0]) + (Gen_Phi - phiEle[0])*(Gen_Phi - phiEle[0]))< 0.1)"
        self.ntrees = 1500
        self.do_eb = True
    ...
    def set_ecal_default(self):
        self.target = "Gen_E/(rawEnergySCEle[0] + esEnergySCEle[0])"
        self.var_eb = ':'.join(["nPV", "rawEnergySCEle[0]", "etaSCEle[0]", "phiSCEle[0]", "energy_5x5SC/rawEnergySCEle[0]"])
    ...
    def set_elecomb_default(self):
        self.var_eb =":".join(["(rawEnergySCEle[0] + esEnergySCEle[0])*regEcalMean","regEcalSigma/regEcalMean","ele.trkPModeErr/ele.trkPMode","(sc.rawEnergy+sc.rawESEnergy)*regEcalMean/ele.trkPMode","ele.ecalDrivenSeed","ssFull.e3x3/sc.rawEnergy","ele.fbrem","ele.trkEtaMode","ele.trkPhiMode"])
